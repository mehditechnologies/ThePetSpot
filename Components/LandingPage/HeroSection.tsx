...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Content center (big heading + search) */}
      <div className="relative z-20 mt-32 w-full max-w-[1100px] text-center px-6">
        ...
        <div className="flex flex-col  md:flex-row items-center justify-center gap-2">
          <select className=" rounded-sm outline-none active:outline-none font-semibold bg-white   p-3 w-full md:w-[450px] text-gray-700">
          ...
          <button className="bg-[#028d8f] rounded-sm px-20 py-2 font-medium  text-white hover:bg-[#037273]">
            Search
          </button>
        </div>
      ...
      {/* Breeder CTA bar (just below navbar, white area in screenshot) */}
