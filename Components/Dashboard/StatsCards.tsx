...
const SimpleChart = ({ percentage }: { percentage: number }) => (
  <div className="flex items-center mt-3">
    <div className="w-full bg-gray-200 rounded-full h-2">
      <div 
        className="h-2 rounded-full transition-all duration-500 ease-out bg-[#028d8f]"
        style={{ width: `${Math.min(percentage, 100)}%` }}
      ></div>
    </div>
    <span className="ml-3 text-xs font-medium text-[#028d8f]">{percentage.toFixed(0)}%</span>
  </div>
);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="flex items-center mb-4">
                <div className="p-4 rounded-full bg-[#028d8f] text-white shadow-lg">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-4xl font-bold text-[#028d8f]">{totalAds}</p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-200">
          <div className="text-center">
            <div className="p-3 rounded-full bg-gray-100 text-[#028d8f] mx-auto w-fit mb-3">
            ...
            <p className="text-3xl font-bold text-[#028d8f] mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 hover:shadow-lg transition-all duration-200">
          <div className="flex items-center">
            <div className="p-2 rounded-lg bg-gray-100 text-[#028d8f]">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-bold text-[#028d8f]">{stats.pending}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 hover:shadow-lg transition-all duration-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-bold text-[#028d8f]">{stats.approved}</p>
            </div>
          </div>
          <SimpleChart percentage={stats.approvedPercentage} />
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 hover:shadow-lg transition-all duration-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-bold text-[#028d8f]">{stats.rejected}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 hover:shadow-lg transition-all duration-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-bold text-[#028d8f]">{stats.thisMonth}</p>
            </div>
          </div>
